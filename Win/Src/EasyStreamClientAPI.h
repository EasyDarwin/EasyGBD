...
// 播放速度
typedef enum __EASY_STREAM_CLIENT_PLAY_SPEED_ENUM
{
	EASY_STREAM_CLIENT_PLAY_SPEED_UNKNOWN = -1,
	EASY_STREAM_CLIENT_PLAY_SPEED_NORMAL = 0x00,		// 正常播放
	EASY_STREAM_CLIENT_PLAY_SPEED_PAUSED,				// 暂停
	EASY_STREAM_CLIENT_PLAY_SPEED_SLOW_X2,				// 1/2
	EASY_STREAM_CLIENT_PLAY_SPEED_SLOW_X4,				// 1/4
	EASY_STREAM_CLIENT_PLAY_SPEED_SLOW_X8,				// 1/8
	EASY_STREAM_CLIENT_PLAY_SPEED_SLOW_X16,				// 1/16
	EASY_STREAM_CLIENT_PLAY_SPEED_FAST_X2,				// x2
	EASY_STREAM_CLIENT_PLAY_SPEED_FAST_X4,				// x4
	EASY_STREAM_CLIENT_PLAY_SPEED_FAST_X8,				// x8
	EASY_STREAM_CLIENT_PLAY_SPEED_FAST_X16,				// x16
}EASY_STREAM_CLIENT_PLAY_SPEED_ENUM;
...
extern "C" 
{
	...
	// Seek
	Easy_API int Easy_APICALL EasyStreamClient_Seek(Easy_Handle handle, int secs);
	// Set play speed
	Easy_API int Easy_APICALL EasyStreamClient_SetPlaySpeed(Easy_Handle handle, EASY_STREAM_CLIENT_PLAY_SPEED_ENUM playSpeed);
