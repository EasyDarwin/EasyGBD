...
BOOL CEasyGBDDemoApp::InitInstance()
{
	...
	CoInitialize(NULL);
	listDevices(LocalVideoDeviceMap, CLSID_VideoInputDeviceCategory);// CLSID_AudioInputDeviceCategory);
	//listDevices(LocalAudioDeviceMap, CLSID_AudioInputDeviceCategory);// CLSID_AudioInputDeviceCategory);
